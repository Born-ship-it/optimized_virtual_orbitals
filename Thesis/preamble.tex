...
% ---- DYSLEXIA-FRIENDLY SANS-SERIF -------------------------
\usepackage{tgheros}          % TeXGyre Heros (Helvetica clone, sans-serif)
\renewcommand{\familydefault}{\sfdefault}  % Use sans-serif as default font
...
\raggedbottom  % Avoid stretching vertical space on pages with little content
...
\usepackage{pdftexcmds}     % For \pdf@filesize (if needed)
