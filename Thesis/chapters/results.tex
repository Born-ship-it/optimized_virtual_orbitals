...
\subsection{Energy Recovery as a Function of Active Virtual Orbital Count}
...
\subsubsection{Effect of Initialization Strategy -> Write it into above!!!}
% ---------------------------------------------------------------
% [SECTION INTRO – 6.4]
...
\subsubsection{Comparison with Adamowicz and Bartlett (1987) - "Skip?"}
% ---------------------------------------------------------------
% [SECTION INTRO – 6.6]
...
% Convergence iteration plot!!!! for basis set ... 