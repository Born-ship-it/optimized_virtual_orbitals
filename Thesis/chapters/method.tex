...
The MP2 correlation energy is then evaluated using these amplitudes and the antisymmetrized integrals, see Appendix~\ref{appc:code} for the full implementation. 
